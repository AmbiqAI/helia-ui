 ...
 * some other way, so this reads the served HTML rather than the DOM: eight
 * figures across the six examples, five standing alone and three in the group.
 */
const GALLERY_CHARTS = 8;
